...
# parameters = dict(optimizer=['sgd', 'adam'], activation=['relu', 'leaky_relu', 'tanh'], batch_size=[16,32,64,128])

# #Initializing Randomized Search
# random_search = RandomizedSearchCV(model, parameters, cv=5, n_iter=10)

# #Initializing Callbacks
# early_stopping = EarlyStopping(monitor='val_accuracy', patience=10)
# model_checkpoint = ModelCheckpoint('weights.hdf5', monitor='val_accuracy', save_best_only=True)
...
print(model_cfg)
predictions = model.evaluate(val_images, val_labels)
print(predictions)
print('Loss: {}, Accuracy: {}'.format(predictions[0], predictions[1]))